...
--
-- Хост: localhost
-- Час створення: Трв 14 2015 р., 18:20
...
(35, 'Топологія', 2, 0, 'Нехай $X - $ непорожня. Сім''я підмножин $\\tau$ в $X$ називається топологією, якщо:<br>\r\n1. $\\oslash \\in \\tau;$ <br>\r\n2. $ x \\in \\tau;$ <br>\r\n3. $\\forall U, V \\in \\tau, U \\cap V \\in \\tau $; <br>\r\n4. Якщо сім''я $U_\\alpha\\in\\tau$; <br>\r\n\r\n', 1),
...
(38, 'Неперервне відображення', 2, 0, 'Нехай $(X,\\tau_{x})$, $(X,\\tau_{y}) -$ топологічні простори.\r\n$F:X\\rightarrow X$--- відображення. <br>\r\n$F$ називається неперервним в точці $x_0\\in X$, якщо для будь-якого околу $\\;V\\;$ точки $f(x_0)\\in X$ існує окіл $U$ точки $x_0\\in X$ такий, що: $F(U)\\subset V$ тобто $\\forall x\\in U, F(X)\\in V$.', 1),
(39, 'Гомеоморфізм', 2, NULL, 'Відображення $F$ між топологічними просторами $X$ та $Y$ називається ${\\it гомеоморфізмом} $, якщо:<br>\r\n1. $F - $ бієктивне;<br>\r\n2. $F - $ неперевне;<br>\r\n3. $F^{-1} - $ неперервне.', 1),
(40, 'Про неперервність відображення', 2, NULL, 'Відображення $F:X\\rightarrow X$ буде неперевне в кожній точці $x_0\\in X$ тоді і тільки тоді, коли прообраз кожної відкритої множини з $Y$ буде відкритою множиною в $X$.<br>\r\nТобто $\\forall\\;V\\in\\tau_x, F_{-1}(V)=\\{x\\in~X|F(x)\\in~V\\}~\\in~\\tau_x$', 4),
...
(47, 'Гаусдорфовий простір', 2, NULL, 'Кожен метричний простір є гаусдорфовим.', 4),
(49, 'Приклад метричного простору', 2, NULL, '$R^n\\ni x,\\quad x=(x_1,x_2,\\ldots,x_n),\\quad x_k\\in R$<br>\r\n$$d_2(x,y)=\\sqrt{\\sum_{k=1}^n{(x_k-y_k)^2}}$$\r\n$(R^n,d_2)$', 5),
(50, 'Приклад метричного простору №2', 2, NULL, '$(R^n,d_p)$,$1\\leq p< \\infty$\r\n$$d_p(x,y)=\\left({\\sum_{k=1}^n{|x_k-y_k|^p}}\\right)^{\\frac{1}{p}}$$', 1),
(51, 'Приклад метричного простору №3', 2, NULL, '$(R^n,d_{\\infty})$\r\n$$d_{\\infty}(x,y)=\\max|x_k-y_k|$$', 5),
(52, 'Приклад метричного простору №4', 2, NULL, '$l_p, 1\\leq p<\\infty$ простір послідовностей(або векторів з нескінченою кількістю координати)<br>\r\n$x(x_1,x_2,\\ldots,x_n,\\ldots)$, таких що ряд\r\n$\\sum\\limits_{k=1}^{\\infty}{|x|^p}<\\infty({\\text ряд збіжний})$<br>\r\n$$d_p(x,y)=\\left({\\sum_{k=1}^n{|x_k-y_k|^p}}\\right)^{\\frac{1}{p}}$$', 1),
(53, 'Приклад метричного простору №5', 2, NULL, '$l_{\\infty}$, $x\\in l_{\\infty}$, $x=(x_1,x_2,\\dots,x_n,\\ldots)$<br>\r\n$\\sup|x_k|<\\infty$<br>\r\n$$d_{\\infty}(x,y)=\\sup_{k}|x_k-y_k|$$', 5),
(54, 'Приклад метричного простору №6', 2, NULL, '$C_0 - $ простір всіх збіжних до нуля послідовностей з метрикою $\\;d_{\\infty}$', 5),
(55, 'Приклад метр простору №8', 2, NULL, '$C - $простір всіх збіжних послідовностей з метрикою $\\;~d_{\\infty}$', 1),
(57, 'Приклад метричного простору №7', 2, NULL, '$P[a,b] - $ простір всіх многочленів від $t\\in[a,b]$ з метрикою рівномірної збіжності.', 1),
(58, 'Приклад метричного простору №10', 2, NULL, '$L_p[a,b] - $ множина класів еквівалентності інтегровних в степені $p$ функцій за Лебегом на [a,b], де $1\\leq p<\\infty$<br>\r\nТобто $f\\sim g$ якщо $f$ і $g$ відрізняються на множині міри $0$.<br>\r\n$x(t)\\in L_p[a,b]$ якщо $\\int\\limits_{[a,b]}|f(t)|^pd\\mu$ існує\r\n$$d_p(x,y)=\\left(\\int\\limits_{[a,b]}|x(t)-y(t)|^p\\right)^{\\frac{1}{p}}$$', 1),
(59, 'Приклад метр простору №11', 2, NULL, '$L_p[a,b]$<br>\r\nСуттєвий супремум інтегрованої за Лебегом функції $x(t)$ називається<br>\r\n$$\\inf_{zez}\\sup_{t\\in[a,b]}|z(t)|=ess\\sup_{t\\in[a,b]}|x(t)-y(t)|$$\r\n$L_p[a,b] - $ простір інтегрованих обмежених функцій(класів еквівалентності)\r\n$$d_{\\infty}(x,y)=ess\\sup_{t\\in[a,b]}|x(t)-y(t)|$$', 1),
(60, 'Підпростір метричного простору', 2, NULL, 'Нехай $(X,d) - $ метричний простір. Тоді метричний простір$ ~(X_0,d_0)$ називається підпростором $(X,d)$, якщо:\r\n1. $X_0\\subset X$<br>\r\n2. $\\forall x,y\\in X_0,\\quad d_0(x,y)=d(x,y)$', 1),
...
(65, 'Приклад неповного простору № 1', 2, NULL, 'Нехай $X_0\\subset X - $ підпростір, але $X_0 - $ незамкнена підмножина в $X$', 1),
(66, 'Приклад неповного простору № 2', 2, NULL, '$P[a,b] - $ простір многочленів на $[a,b]$<br>\r\nЗа теоремою Вейєрштрасса про те, що кожна неперервна функція наближена многочленами рівносильно на  $[a,b]$.', 1),
(67, 'Приклад неповного простору № 3', 2, NULL, '$C_{00} - $ простір фінітних послідовностей. \r\n<br>$x\\in C_{00}$<br>\r\n$x=(\\textbf{x},0,0,\\ldots)$', 1),
...
(72, 'Відкрите покриття простору', 2, NULL, 'Відкритим покриттям простору $X$ називається сім''я відкритих множин $\\{U_{\\alpha}\\}$, що $\\cup_{\\alpha}U_{\\alpha}\\supset X$. Підпокриття це підмножина в $\\{U_{\\alpha}\\}$, яка також є покриттям.', 1),
(73, 'Компактний метричний простір', 2, NULL, 'Компактний метричний простір $X$ є повним.', 4),
(74, 'Приклад компактного простору', 2, NULL, '$X=S(l_2)=\\{x\\in l_2|d_2(x,0)=1\\}$<br>\r\n$0=(0,0,\\ldots,0,\\ldots)$<br>\r\n$({x},\\ldots)$<br>\r\n$d(x,0)=\\left(\\sum\\limits_{n=1}^{\\infty}x_n^2\\right)=1$ --- одинична сфера<br>\r\n$(S,d_2)\\subset l_2$<br>\r\n$(S,d_2) - $ повний метричний простір як замкнена множина в повному просторі $l_2$<br>\r\n$(S,d_2) - $ обмежений, бо $d(x,y)\\leq2, x,y\\in S$<br>\r\nРозглянемо таку послідовність $e_n=(0,0,\\ldots,\\parbox[t]{4pt}{1 \\uparrow n},0,\\ldots)$<br>\r\n$n\\neq m$<br>\r\n$d(e_n,e_m)=\\sqrt{1^2+1^2}=\\sqrt{2}$<br>\r\nРозглянемо таке покриття $S$, яке складається з двох куль радіуса $\\frac{\\sqrt{2}}{4}$ з центром в кожній точці. В одну з цих куль може попасти тільки один елемент нашої послідовності. Тому, якщо існує скінчення покриття, то воно накриває тільки скінченну кількість $\\{e_n\\}$, а тому такого покриття не існує.', 1),
...
(78, 'Скінченновимірний базис', 0, NULL, 'Якщо в лінійному просторі $X$ існує скінченний базис Гамеля.$\\{\\p{e}\\}$, то $X$ називається ${\\bfскінченновимірним}$($n$-вимірним)<br>\r\n$\\dim X=n$.<br>\r\nВ іншому випадку $X$ називається {\\bfнескінченновимірним} $\\dim X=\\infty$', 1),
(79, 'Норма на просторі', 0, NULL, 'Нехай $X$$-$лінійний простір над полем дійсних чисел $\\BBR$.<br>\r\nФункція $||x||$ визначена на $X$ зі значенням в $\\BBR$ називається ${\\bfнормою}$, якщо:<br>\r\n1. $||x||\\geq, \\forall x\\in X$.<br>\r\n2. $||x||=0 \\Leftrightarrow x=0$.<br>\r\n3. $||\\lambda x||=\\lambda||x||, \\quad \\forall \\lambda\\in\\BBR, x\\in X$.<br>\r\n4. Нерівність трикутника<br>\r\n$||x+y||\\leq||x||+||y||$', 1),
(80, 'Банаховий простір', 0, NULL, 'Повний нормований простір називається ${\\bfбанаховим}$ простором', 1),
(81, 'Лінійний оператор', 0, NULL, 'Нехай $X,Y$$-$нормовані простори. Відображення $A:X\\rightarrow Y$ називаться ${\\bfлінійним оператором}$, якщо:<br> \r\n1. $A(x_1+x_2)=A(x_1)+A(x_2),\\quad \\forall x_1,x_2\\in X$.<br>\r\n2. $A(\\lambda x)=\\lambda A(x), \\quad \\forall\\lambda\\in\\BBR, x\\in X$. ', 1),
(82, 'Лінійний функціонал', 0, NULL, 'Лінійний оператор з $X$ в $X$ називається ${\\bfлінійним функціоналом}.$', 1),
(83, 'Ізоморфізм', 0, NULL, 'Лінійний оператор $A$ з нормованого простору $X$ в нормований простір $Y$ називається ${\\bfізоморфізмом}$, якщо: <br>\r\n$A$$-$бієктивний, $A$$-$неперервний і $A^{-1}$$-$неперервний.', 1),
(84, 'Обмежений лінійний оператор', 0, NULL, 'Лінійний оператор $A:X\\rightarrow Y(X,Y-\\text{нормовані})$ називається ${\\bfобмеженим}$, якщо $A$$-$обмежений на $\\overline{B_1(0)}$$-$кулі в $X$ радіуса 1 з центром в нулі. Тобто $$\\sup_{||x||\\leq1}{||A(x)||<\\infty}$$', 1),
(85, 'Пряма сума просторів', 0, NULL, 'Нехай $X,Y$$-$банахові простори.${\\bfПрямою\\;сумою}$ просторів $X\\oplus Y$ називають банахів простір, елементи якого мають вигляд $x+y$, де $x\\in X, y\\in Y$ і це зображення єдине.<br>\r\n$||x+y||=\\max(||x||,||y||)$. Пряма сума ізоморфна до декартового добутку. <br>\r\n$X\\times Y=\\{(x,y)|x\\in X,y\\in Y\\}$<br>\r\n$||(x,y)||=\\max(||x||,||y||)$. Очевидно, що $X$ є замкненим підпротором в $X\\oplus Y$', 1),
(87, 'Доповнювальний і доповнюваний простори', 0, NULL, 'Нехай $Z$$-$банахів простір. $X$$-$замкнений підпростір. $X$$-$називається ${\\bfдоповнювальним}$ в $Z$, якщо існує замкнений підпростір $Y\\subset Z$, що $Z=X\\oplus Y$. $Y$$-$називається ${\\bfдоповнюваним}$ до $X$.', 1),
(88, 'Оператор проектор', 0, NULL, 'Нехай $Z$$-$банахів простір. $X$$-$замкнений підпростір. Оператор $P:Z\\rightarrow X$ називається ${\\bfпроектором}$, якщо<br>\r\n1. $P$ є сюр''єктивним.<br>\r\n2. $P(P(Z))=P(Z), \\forall z\\in Z$.', 1),
(89, 'Лінійно незалежна і лінійно залежна сім''ї', 0, NULL, 'Нехай $X$$-$деякий лінійний простір. Сім''я ненульових векторів $\\{z_{\\alpha}\\}$$-$називається ${\\bfлінійно\\; незалежною}$($\\alpha$ пробігає деяку множину індексів) якщо з того, що <br>\r\n$$\\lambda_1\\alpha_1+\\lambda_2\\alpha_2+\\ldots+\\lambda_n\\alpha_n=0$$	для деяких числел $\\p{\\lambda}$ випливає, що $\\lambda_1=\\ldots=\\lambda_n=0$. <br>\r\nВ іншому випадку $\\{z_{\\alpha}\\}$ називаєтсья ${\\bf лінійно залежною}$.', 1),
(90, 'Відношення порядку', 0, NULL, 'Нехай $\\{z_{\\alpha}\\}$ і $\\{y_{\\beta}\\}$ дві лінійно незалежні сім''ї. Введомо порядок $\\{z_{\\alpha}\\}\\leq\\{y_{\\beta}\\}$, якщо\r\n$\\{z_{\\alpha}\\}\\subseteq\\{y_{\\beta}\\}$<br>\r\nЗауважимо, що введення $\\leq$ відношення є відношенням часткового порядку.', 1),
(91, 'Ланцюг', 0, NULL, 'Підмножина частково впорядкованої множини називається ${\\bfланцюгом}$, якщо вона є лінійно впорядкована(тобто будь-які два елемента з цієї підмножини можна порівняти)', 1),
(92, 'Лінійний базис або базис Гамеля', 0, NULL, '${\\bfЛінійним базисом}$(базисом Гамеля)в лінійному просторі називається максимальна сім''я лінійно незалежних векторів.', 1),
(93, 'Базис Шаудера', 0, NULL, 'Лінійно незалежна послідовність $\\{e_{\\infty}\\}$  банахового простору $X$ називається ${\\bf базисом Шаудера}$(топологічним базисом), якщо для будь-~якого $x\\in X$ існує послідовність чисел $\\{\\lambda_n\\}\\subset \\BBR $ така, що <br>\r\n$x=\\sum_{n=1}^{\\infty}{\\lambda_ne_n}=\\lim_{m\\rightarrow\\infty}\\sum_{n=1}^{\\infty}{\\lambda_ne_n}$, тобто<br> $||x-\\sum_{n=1}^{m}{\\lambda_ne_n}||\\rightarrow0$, при $m\\rightarrow\\infty$', 1),
(94, 'Продовження функціоналу', 0, NULL, 'Нехай $X$$-$нормований простір, $X_0$$-$підпростір в $X$. Нехай $f_0$$-$лінійний неперервний функціонал на $X_0$, тобто $f\\in X_0$. Тоді функціонал $f\\in X$ називаєтся ${\\bfпродовженням}$ функціоналу $f_0$, якщо $f(x)=f_0(x), \\forall x\\in X_0$', 1),
(96, 'Епсилон-сітка', 0, NULL, 'Нехай $X-$ метричний простір, $X_0\\subset X-$ підпростір.<br>\r\nПідмножина $M\\subset X$ називається  $\\epsilon$-${\\bfсіткою}$ підпростору $X_0$, якщо:<br>\r\n$\\forall x_0\\in X_0, \\exists a\\in M,\\, \\text{що}\\, d(x_0,a) $', 1),
(97, 'Цілком обмежений простір', 0, NULL, 'Підпростір $X$ називається ${\\bfцілком \\;обмежений}$, якщо:<br>\r\n$\\forall\\epsilon>0\\quad\\exists$ скінченнa {\\bf $\\epsilon$--сітка} підпростору $X_0$', 1),
(98, 'Одностайно неперервна сім''я функцій', 0, NULL, 'Сім''я функцій $\\{\\Phi_{\\alpha}|\\Phi_{\\alpha}(t)\\in[a,b]\\}$ називається ${\\bf одностайно неперервною}$, якщо:<br>\r\n$\\forall\\epsilon>0,\\exists\\delta>0, \\text{що}\\;\\forall\\,t_1,t_2\\in[a,b],<br> \\text{що} |t_1-t_2|<\\delta \\Rightarrow |\\Phi_{\\alpha}(t_1)-\\Phi_{\\alpha}(t_2)|<\\epsilon, \\forall\\alpha$', 1),
(99, 'Обмежена сім''я функцій', 0, NULL, 'Сім''я функцій $\\{\\Phi_{\\alpha}\\}$ називається ${\\bf обмеженою}$, якщо:<br>\r\n$\\forall C>0,$що $|\\Phi_{\\alpha}(t)|$<C, <br>\r\n$\\forall\\alpha, \\forall t \\in [a,b]$ ', 1);
...
--
ALTER TABLE `user_note`
  MODIFY `user_note_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=92;
--
